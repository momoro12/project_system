...
Проектируемая **информационная система аэропорта** предназначена для информационной поддержки основных процессов аэропорта:

- учета работников, отделов и бригад;
- учета самолетов, их техосмотров и ремонтов;
- планирования рейсов и ведения расписания;
- продажи, бронирования и возврата билетов;
- учета пассажиров и багажа;
- регистрации задержек и отмен рейсов;
- формирования отчетов и выборок по заданным критериям.

Система не управляет физическими процессами напрямую, а **хранит, обрабатывает и предоставляет данные**, необходимые для управления аэропортом.
